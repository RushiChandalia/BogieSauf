    ...
    <div id="About Us" className="about">
      ...
      <div className="about-desktop">
        <div className="about-tabs">
          <span className={`${tab === "About" ? "tab-active":""} tab`}
            onClick={() => {
              setTab("About");
            }}
          >
        ...
        <div className="tab-content-about">
            ...
            <span>
              ...
              <p>
                ...
                problems of cessing due to tire puncture. Every once in wheel, a
                tire goes flat and someone's journey is hindered, and to prevent
                this hindrance, to ensure safe passage to the destination, a
                product has been developed to constantly maintain tire pressure
                and a setup has been established to ensure safe passage in spite
                of vehicul puncture.
              </p>
              </span>
              <span>
              ...
              <p>
                ...
                safe and prevent the travellers from all unwanted situations. To
                keep human safety in a lonely road and area, we have moulded
                this product that can work till the destination even after
                getting a puncture, so nobody needs to pull down the vehicle.
                That's why BogieSauf is here with this solution.
              </p>
              </span>
            </>
        </div>
